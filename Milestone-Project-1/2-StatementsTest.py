...
#___________________________________________________________________________
#Question4: Go through the string below and if the length of a word is even print "even!" st = 'Print
...
# string below: Use a List Comprehension to create a list of the first letters of every word in the
# string below(Use 2 mothod to solve this): st = 'Create a list of the first letters of every word
# in this string'
